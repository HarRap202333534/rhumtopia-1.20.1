...
public class Cobblestone {
    ...
    public static final Block BASALT_COBBLESTONE_FENCE = registerBlock("basalt_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block BEDROCK_FENCE = registerBlock("bedrock_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block VALYRIAN_STONE_FENCE = registerBlock("valyrian_stone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block DARK_GREY_COBBLESTONE_FENCE = registerBlock("dark_grey_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block DARK_GREY_DARK_COBBLESTONE_FENCE = registerBlock("dark_grey_dark_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block BROWN_GREY_COBBLESTONE_FENCE = registerBlock("brown_grey_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block BROWN_GREY_DARK_COBBLESTONE_FENCE = registerBlock("brown_grey_dark_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block BROWN_GREY_COBBLE_FENCE = registerBlock("brown_grey_cobble_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block BROWN_GREY_RIVER_COBBLE_FENCE = registerBlock("brown_grey_river_cobble_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block GREEN_GREY_COBBLESTONE_FENCE = registerBlock("green_grey_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block DARK_COBBLESTONE_FENCE = registerBlock("dark_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block GREY_DARK_COBBLESTONE_FENCE = registerBlock("grey_dark_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block RIVER_COBBLE_FENCE = registerBlock("river_cobble_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block FAINT_LIGHT_GREY_COBBLESTONE_FENCE = registerBlock("faint_light_grey_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block FAINT_LIGHT_GREY_DARK_COBBLESTONE_FENCE = registerBlock("faint_light_grey_dark_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block WHITE_COBBLESTONE_FENCE = registerBlock("white_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block WHITE_DARK_COBBLESTONE_FENCE = registerBlock("white_dark_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block REACH_COBBLESTONE_FENCE = registerBlock("reach_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block REACH_DARK_COBBLESTONE_FENCE = registerBlock("reach_dark_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block KL_DUN_COBBLE_FENCE = registerBlock("kl_dun_cobble_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block RED_COBBLESTONE_FENCE = registerBlock("red_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block COARSE_RED_DARK_COBBLESTONE_FENCE = registerBlock("coarse_red_dark_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block OLDTOWN_COBBLESTONE_FENCE = registerBlock("oldtown_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block OLDTOWN_DARK_COBBLESTONE_FENCE = registerBlock("oldtown_dark_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block LANNISPORT_COBBLESTONE_FENCE = registerBlock("lannisport_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block LANNISPORT_DARK_COBBLESTONE_FENCE = registerBlock("lannisport_dark_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block STORMLANDS_COBBLESTONE_FENCE = registerBlock("stormlands_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block STORMLANDS_DARK_COBBLESTONE_FENCE = registerBlock("stormlands_dark_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block STORMLANDS_MOSSY_COBBLESTONE_FENCE = registerBlock("stormlands_mossy_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block TERRACOTTA_COBBLESTONE_FENCE = registerBlock("terracotta_cobblestone_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
