...
public class WcItemGroupBrick {
    public static final ItemGroup BRICK = FabricItemGroup.builder()
            ...
            .entries((context, entries) -> {
                ...
                entries.add(Brick.SMALL_ORANGE_BRICK_STAIRS);
                entries.add(Brick.SMALL_ORANGE_BRICK_SLAB);
                entries.add(Brick.SMALL_ORANGE_BRICK_WALL);
                entries.add(Brick.SMALL_ORANGE_BRICK_FENCE);
                entries.add(Brick.SMALL_ORANGE_BRICK_HOPPER);
                entries.add(Brick.SMALL_ORANGE_BRICK_TIP);
                entries.add(Brick.SMALL_ORANGE_BRICK_ARROW_SLIT);
                entries.add(Brick.SMALL_ORANGE_BRICK_ARROW_SLIT_WINDOW);
                entries.add(Brick.SMALL_ORANGE_BRICK_ARROW_SLIT_ORNATE);
