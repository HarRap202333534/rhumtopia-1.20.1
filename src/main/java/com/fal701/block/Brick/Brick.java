...
public class Brick {
    ...
    public static final Block SMALL_ORANGE_BRICKS_STAIRS = registerBlock("small_orange_bricks_stairs", new WcStairs(SMALL_ORANGE_BRICKS.getDefaultState(), FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_ORANGE_BRICKS_SLAB = registerBlock("small_orange_bricks_slab", new SlabBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_ORANGE_BRICKS_WALL = registerBlock("small_orange_bricks_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_ORANGE_BRICKS_FENCE = registerBlock("small_orange_bricks_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_ORANGE_BRICKS_HOPPER = registerBlock("small_orange_bricks_hopper", new WcHopper(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_ORANGE_BRICKS_TIP = registerBlock("small_orange_bricks_tip", new WcHopperU(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_ORANGE_BRICKS_ARROW_SLIT = registerBlock("small_orange_bricks_arrow_slit", new WcArrowSlit(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_ORANGE_BRICKS_ARROW_SLIT_WINDOW = registerBlock("small_orange_bricks_arrow_slit_window", new WcArrowSlit(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_ORANGE_BRICKS_ARROW_SLIT_ORNATE = registerBlock("small_orange_bricks_arrow_slit_ornate", new WcArrowSlit(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block ROUGH_SOUTHERN_BRICK = registerBlock("rough_southern_bricks", new Block(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block ROUGH_SOUTHERN_BRICK_STAIRS = registerBlock("rough_southern_bricks_stairs", new WcStairs(ROUGH_SOUTHERN_BRICK.getDefaultState(), FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block ROUGH_SOUTHERN_BRICK_SLAB = registerBlock("rough_southern_bricks_slab", new SlabBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block ROUGH_SOUTHERN_BRICK_WALL = registerBlock("rough_southern_bricks_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block ROUGH_SOUTHERN_BRICK_FENCE = registerBlock("rough_southern_bricks_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block ROUGH_SOUTHERN_BRICK_HOPPER = registerBlock("rough_southern_bricks_hopper", new WcHopper(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block ROUGH_SOUTHERN_BRICK_TIP = registerBlock("rough_southern_bricks_tip", new WcHopperU(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block DARK_SOUTHERN_BRICK = registerBlock("dark_southern_bricks", new Block(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block DARK_SOUTHERN_BRICK_STAIRS = registerBlock("dark_southern_bricks_stairs", new WcStairs(DARK_SOUTHERN_BRICK.getDefaultState(), FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block DARK_SOUTHERN_BRICK_SLAB = registerBlock("dark_southern_bricks_slab", new SlabBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block DARK_SOUTHERN_BRICK_WALL = registerBlock("dark_southern_bricks_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block DARK_SOUTHERN_BRICK_FENCE = registerBlock("dark_southern_bricks_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block DARK_SOUTHERN_BRICK_HOPPER = registerBlock("dark_southern_bricks_hopper", new WcHopper(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block DARK_SOUTHERN_BRICK_TIP = registerBlock("dark_southern_bricks_tip", new WcHopperU(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
