...
public class Brick {
    ...
    public static final Block SMALL_ORANGE_BRICK_WALL = registerBlock("small_orange_brick_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block ORANGE_BRICK_WALL = registerBlock("orange_brick_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block DARK_ORANGE_BRICK_WALL = registerBlock("dark_orange_brick_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SOUTHERN_BRICK_WALL = registerBlock("southern_brick_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block ROUGH_SOUTHERN_BRICK_WALL = registerBlock("rough_southern_brick_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block DARK_SOUTHERN_BRICK_WALL = registerBlock("dark_southern_brick_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
