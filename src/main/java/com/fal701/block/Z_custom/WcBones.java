...
public class WcBones extends HorizontalFacingBlock {

    public static final DirectionProperty FACING = Properties.FACING;
    public static final EnumProperty<StateStateBones> BONES = EnumProperty.of("state", StateStateBones.class);

    public WcBones(Settings settings) {
        super(settings);
        this.setDefaultState(this.getDefaultState().with(FACING, Direction.NORTH).with(BONES, StateStateBones.RANDOM));
    }
