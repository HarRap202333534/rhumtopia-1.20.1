...
public class WcBed extends BlockWithEntity implements BlockEntityProvider{
    ...
    public WcBed(DyeColor color, Settings settings) {
        super(settings);
        this.color = color;
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new WcBedEntity(pos, state);
    }
    ...
    static {
        ...
        NORTH_SHAPE = Block.createCuboidShape(0,0,0,16,9,16);
        SOUTH_SHAPE = Block.createCuboidShape(0,0,0,16,9,16);
        WEST_SHAPE = Block.createCuboidShape(0,0,0,16,9,16);
        EAST_SHAPE = Block.createCuboidShape(0,0,0,16,9,16);
    }
}
