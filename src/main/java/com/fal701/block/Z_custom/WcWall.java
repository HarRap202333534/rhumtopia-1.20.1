...
public class WcWall extends Block {
    ...
    public WcWall(AbstractBlock.Settings settings) {
        super(settings);
    ...
    private boolean shouldConnectTo(BlockState state, boolean faceFullSquare, Direction side) {
        ...
        return state.getBlock() instanceof WallBlock || state.getBlock() instanceof WcWall || !cannotConnect(state) && faceFullSquare || block instanceof PaneBlock || bl;
    }
