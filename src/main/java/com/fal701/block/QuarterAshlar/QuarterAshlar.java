...
public class QuarterAshlar {
    ...
    public static final Block BASALT_BRICK_WALL = registerBlock("basalt_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block BASALT_BRICK_FENCE = registerBlock("basalt_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_DARK_GREY_BRICK_WALL = registerBlock("small_dark_grey_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_DARK_GREY_BRICK_FENCE = registerBlock("small_dark_grey_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_SMOOTH_BROWN_GREY_BRICK_WALL = registerBlock("small_smooth_brown_grey_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_SMOOTH_BROWN_GREY_BRICK_FENCE = registerBlock("small_smooth_brown_grey_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_BROWN_GREY_BRICK_WALL = registerBlock("small_brown_grey_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_BROWN_GREY_BRICK_FENCE = registerBlock("small_brown_grey_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_STONE_BRICK_WALL = registerBlock("small_stone_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_STONE_BRICK_FENCE = registerBlock("small_stone_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block MOSSY_SMALL_STONE_BRICK_WALL = registerBlock("mossy_small_stone_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block MOSSY_SMALL_STONE_BRICK_FENCE = registerBlock("mossy_small_stone_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_SMOOTH_STONE_BRICK_WALL = registerBlock("small_smooth_stone_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_SMOOTH_STONE_BRICK_FENCE = registerBlock("small_smooth_stone_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_SMOOTH_STONE_BRICK_TIP = registerBlock("small_stone_smooth_brick_tip", new WcHopperU(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_FAINT_LIGHT_GREY_BRICK_WALL = registerBlock("small_faint_light_grey_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_FAINT_LIGHT_GREY_BRICK_FENCE = registerBlock("small_faint_light_grey_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_WHITE_BRICK_WALL = registerBlock("small_white_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_WHITE_BRICK_FENCE = registerBlock("small_white_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block REACH_BRICK_WALL = registerBlock("reach_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block REACH_BRICK_FENCE = registerBlock("reach_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SANDY_PINK_BRICK_WALL = registerBlock("sandy_pink_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SANDY_PINK_BRICK_FENCE = registerBlock("sandy_pink_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_KL_DUN_BRICK_WALL = registerBlock("small_kl_dun_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_KL_DUN_BRICK_FENCE = registerBlock("small_kl_dun_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_COARSE_RED_BRICK_WALL = registerBlock("small_coarse_red_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_COARSE_RED_BRICK_FENCE = registerBlock("small_coarse_red_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block UNUSED_PURPLE_BRICK_WALL = registerBlock("unused_purple_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block UNUSED_PURPLE_BRICK_FENCE = registerBlock("unused_purple_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block DARK_RED_BRICK_WALL = registerBlock("dark_red_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block DARK_RED_BRICK_FENCE = registerBlock("dark_red_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_OLDTOWN_BRICK_WALL = registerBlock("small_oldtown_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_OLDTOWN_BRICK_FENCE = registerBlock("small_oldtown_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_SMOOTH_OLDTOWN_BRICK_WALL = registerBlock("small_smooth_oldtown_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_SMOOTH_OLDTOWN_BRICK_FENCE = registerBlock("small_smooth_oldtown_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_ARBOR_BRICK_WALL = registerBlock("small_arbor_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_ARBOR_BRICK_FENCE = registerBlock("small_arbor_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_LANNISPORT_BRICK_WALL = registerBlock("small_lannisport_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_LANNISPORT_BRICK_FENCE = registerBlock("small_lannisport_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_SMOOTH_LANNISPORT_BRICK_WALL = registerBlock("small_smooth_lannisport_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_SMOOTH_LANNISPORT_BRICK_FENCE = registerBlock("small_smooth_lannisport_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block UNUSED_BROWN_BRICK_WALL = registerBlock("unused_brown_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block UNUSED_BROWN_BRICK_FENCE = registerBlock("unused_brown_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block STORMLANDS_BRICK_WALL = registerBlock("stormlands_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block STORMLANDS_BRICK_FENCE = registerBlock("stormlands_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block SMALL_TERRACOTTA_BRICK_WALL = registerBlock("small_terracotta_brick_wall", new WallBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    public static final Block SMALL_TERRACOTTA_BRICK_FENCE = registerBlock("small_terracotta_brick_fence", new FenceBlock(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
