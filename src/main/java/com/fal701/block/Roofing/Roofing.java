...
public class Roofing {
    ...
    public static final Block BLACK_SLATE_WALL = registerBlock("black_slate_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block BLUE_SLATE_WALL = registerBlock("blue_slate_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block RED_SLATE_WALL = registerBlock("red_slate_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block BROWN_SLATE_WALL = registerBlock("brown_slate_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block GREEN_SLATE_WALL = registerBlock("green_slate_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block ORANGE_SLATE_WALL = registerBlock("orange_slate_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block REDORANGE_SLATE_WALL = registerBlock("redorange_slate_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.COBBLESTONE).requiresTool()));
    ...
    public static final Block THATCH_LIGHT_WALL = registerBlock("thatch_light_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.HAY_BLOCK).requiresTool()));
    ...
    public static final Block THATCH_DARK_WALL = registerBlock("thatch_dark_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.HAY_BLOCK).requiresTool()));
    ...
    public static final Block SNOWY_THATCH_LIGHT_WALL = registerBlock("snowy_thatch_light_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.HAY_BLOCK).requiresTool()));
    ...
    public static final Block SNOWY_THATCH_DARK_WALL = registerBlock("snowy_thatch_dark_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.HAY_BLOCK).requiresTool()));
