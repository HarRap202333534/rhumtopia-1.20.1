...
public class MarblePlaster {
    ...
    public static final Block QUARTZ_WALL = registerBlock("quartz_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block QUARTZ_FENCE = registerBlock("quartz_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block WHITE_STAINED_CLAY_WALL = registerBlock("white_stained_clay_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block WHITE_STAINED_CLAY_FENCE = registerBlock("white_stained_clay_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block EYRIE_BLUE_VEINED_MARBLE_WALL = registerBlock("eyrie_blue_veined_marble_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block EYRIE_BLUE_VEINED_MARBLE_FENCE = registerBlock("eyrie_blue_veined_marble_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block BAELORS_BROWN_VEINED_MARBLE_WALL = registerBlock("baelors_brown_veined_marble_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block BAELORS_BROWN_VEINED_MARBLE_FENCE = registerBlock("baelors_brown_veined_marble_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block HIGHGARDEN_PINK_VEINED_MARBLE_WALL = registerBlock("highgarden_pink_veined_marble_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block HIGHGARDEN_PINK_VEINED_MARBLE_FENCE = registerBlock("highgarden_pink_veined_marble_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block HIGHGARDEN_PINK_MARBLE_WALL = registerBlock("highgarden_pink_marble_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block HIGHGARDEN_PINK_MARBLE_FENCE = registerBlock("highgarden_pink_marble_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block SUNSPEAR_YELLOW_VEINED_MARBLE_WALL = registerBlock("sunspear_yellow_veined_marble_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block SUNSPEAR_YELLOW_VEINED_MARBLE_FENCE = registerBlock("sunspear_yellow_veined_marble_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block STARRY_SEPT_MARBLE_WALL = registerBlock("starry_sept_marble_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block STARRY_SEPT_MARBLE_FENCE = registerBlock("starry_sept_marble_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block CITADEL_GREEN_MARBLE_WALL = registerBlock("citadel_green_marble_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block CITADEL_GREEN_MARBLE_FENCE = registerBlock("citadel_green_marble_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block WHITE_PLASTER_WALL = registerBlock("white_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block WHITE_PLASTER_FENCE = registerBlock("white_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block WHITE_PLASTER_ROUGH_WALL = registerBlock("white_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block WHITE_PLASTER_ROUGH_FENCE = registerBlock("white_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PLAIN_WHITE_DAUB_WALL = registerBlock("plain_white_daub_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PLAIN_WHITE_DAUB_FENCE = registerBlock("plain_white_daub_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PLAIN_WHITE_DAUB_ROUGH_WALL = registerBlock("plain_white_daub_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PLAIN_WHITE_DAUB_ROUGH_FENCE = registerBlock("plain_white_daub_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block BROWNISH_WHITE_PLASTER_WALL = registerBlock("brownish_white_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block BROWNISH_WHITE_PLASTER_FENCE = registerBlock("brownish_white_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block BROWNISH_WHITE_PLASTER_ROUGH_WALL = registerBlock("brownish_white_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block BROWNISH_WHITE_PLASTER_ROUGH_FENCE = registerBlock("brownish_white_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PALE_WHITE_PLASTER_WALL = registerBlock("pale_white_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PALE_WHITE_PLASTER_FENCE = registerBlock("pale_white_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PALE_WHITE_PLASTER_ROUGH_WALL = registerBlock("pale_white_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PALE_WHITE_PLASTER_ROUGH_FENCE = registerBlock("pale_white_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block YELLOWISH_WHITE_PLASTER_WALL = registerBlock("yellowish_white_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block YELLOWISH_WHITE_PLASTER_FENCE = registerBlock("yellowish_white_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block YELLOWISH_WHITE_PLASTER_ROUGH_WALL = registerBlock("yellowish_white_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block YELLOWISH_WHITE_PLASTER_ROUGH_FENCE = registerBlock("yellowish_white_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block GREYISH_WHITE_PLASTER_WALL = registerBlock("greyish_white_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block GREYISH_WHITE_PLASTER_FENCE = registerBlock("greyish_white_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block GREYISH_WHITE_PLASTER_ROUGH_WALL = registerBlock("greyish_white_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block GREYISH_WHITE_PLASTER_ROUGH_FENCE = registerBlock("greyish_white_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block LIGHT_GREY_PLASTER_WALL = registerBlock("light_grey_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block LIGHT_GREY_PLASTER_FENCE = registerBlock("light_grey_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block LIGHT_GREY_PLASTER_ROUGH_WALL = registerBlock("light_grey_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block LIGHT_GREY_PLASTER_ROUGH_FENCE = registerBlock("light_grey_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block GREY_PLASTER_WALL = registerBlock("grey_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block GREY_PLASTER_FENCE = registerBlock("grey_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block GREY_PLASTER_ROUGH_WALL = registerBlock("grey_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block GREY_PLASTER_ROUGH_FENCE = registerBlock("grey_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block DARK_GREY_PLASTER_WALL = registerBlock("dark_grey_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block DARK_GREY_PLASTER_FENCE = registerBlock("dark_grey_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block DARK_GREY_PLASTER_ROUGH_WALL = registerBlock("dark_grey_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block DARK_GREY_PLASTER_ROUGH_FENCE = registerBlock("dark_grey_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block LIGHT_RED_PLASTER_WALL = registerBlock("light_red_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block LIGHT_RED_PLASTER_FENCE = registerBlock("light_red_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block LIGHT_RED_PLASTER_ROUGH_WALL = registerBlock("light_red_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block LIGHT_RED_PLASTER_ROUGH_FENCE = registerBlock("light_red_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block RED_PLASTER_WALL = registerBlock("red_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block RED_PLASTER_FENCE = registerBlock("red_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block RED_PLASTER_ROUGH_WALL = registerBlock("red_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block RED_PLASTER_ROUGH_FENCE = registerBlock("red_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block CASTERLY_ROCK_CRIMSON_PLASTER_WALL = registerBlock("casterly_rock_crimson_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block CASTERLY_ROCK_CRIMSON_PLASTER_FENCE = registerBlock("casterly_rock_crimson_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block CASTERLY_ROCK_CRIMSON_PLASTER_ROUGH_WALL = registerBlock("casterly_rock_crimson_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block CASTERLY_ROCK_CRIMSON_PLASTER_ROUGH_FENCE = registerBlock("casterly_rock_crimson_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block DARK_RED_PLASTER_WALL = registerBlock("dark_red_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block DARK_RED_PLASTER_FENCE = registerBlock("dark_red_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block DARK_RED_PLASTER_ROUGH_WALL = registerBlock("dark_red_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block DARK_RED_PLASTER_ROUGH_FENCE = registerBlock("dark_red_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block LANNISPORT_ORANGE_PLASTER_WALL = registerBlock("lannisport_orange_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block LANNISPORT_ORANGE_PLASTER_FENCE = registerBlock("lannisport_orange_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block LANNISPORT_ORANGE_PLASTER_ROUGH_WALL = registerBlock("lannisport_orange_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block LANNISPORT_ORANGE_PLASTER_ROUGH_FENCE = registerBlock("lannisport_orange_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block ORANGE_PLASTER_WALL = registerBlock("orange_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block ORANGE_PLASTER_FENCE = registerBlock("orange_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block ORANGE_PLASTER_ROUGH_WALL = registerBlock("orange_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block ORANGE_PLASTER_ROUGH_FENCE = registerBlock("orange_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block DARK_ORANGE_PLASTER_WALL = registerBlock("dark_orange_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block DARK_ORANGE_PLASTER_FENCE = registerBlock("dark_orange_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block DARK_ORANGE_PLASTER_ROUGH_WALL = registerBlock("dark_orange_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block DARK_ORANGE_PLASTER_ROUGH_FENCE = registerBlock("dark_orange_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block LANNISPORT_YELLOW_PLASTER_WALL = registerBlock("lannisport_yellow_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block LANNISPORT_YELLOW_PLASTER_FENCE = registerBlock("lannisport_yellow_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block LANNISPORT_YELLOW_PLASTER_ROUGH_WALL = registerBlock("lannisport_yellow_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block LANNISPORT_YELLOW_PLASTER_ROUGH_FENCE = registerBlock("lannisport_yellow_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block DORNE_MUD_PLASTER_WALL = registerBlock("dorne_mud_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block DORNE_MUD_PLASTER_FENCE = registerBlock("dorne_mud_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block DORNE_MUD_PLASTER_ROUGH_WALL = registerBlock("dorne_mud_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block DORNE_MUD_PLASTER_ROUGH_FENCE = registerBlock("dorne_mud_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PALE_YELLOW_PLASTER_WALL = registerBlock("pale_yellow_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PALE_YELLOW_PLASTER_FENCE = registerBlock("pale_yellow_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PALE_YELLOW_PLASTER_ROUGH_WALL = registerBlock("pale_yellow_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PALE_YELLOW_PLASTER_ROUGH_FENCE = registerBlock("pale_yellow_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block DORNE_DARK_MUD_PLASTER_WALL = registerBlock("dorne_dark_mud_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block DORNE_DARK_MUD_PLASTER_FENCE = registerBlock("dorne_dark_mud_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block DORNE_DARK_MUD_PLASTER_ROUGH_WALL = registerBlock("dorne_dark_mud_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block DORNE_DARK_MUD_PLASTER_ROUGH_FENCE = registerBlock("dorne_dark_mud_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block ARBOR_BROWN_PLASTER_WALL = registerBlock("arbor_brown_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block ARBOR_BROWN_PLASTER_FENCE = registerBlock("arbor_brown_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block ARBOR_BROWN_PLASTER_ROUGH_WALL = registerBlock("arbor_brown_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block ARBOR_BROWN_PLASTER_ROUGH_FENCE = registerBlock("arbor_brown_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PLAIN_BROWN_DAUB_WALL = registerBlock("plain_brown_daub_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PLAIN_BROWN_DAUB_FENCE = registerBlock("plain_brown_daub_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PLAIN_BROWN_DAUB_ROUGH_WALL = registerBlock("plain_brown_daub_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PLAIN_BROWN_DAUB_ROUGH_FENCE = registerBlock("plain_brown_daub_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block GULLTOWN_GREEN_PLASTER_WALL = registerBlock("gulltown_green_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block GULLTOWN_GREEN_PLASTER_FENCE = registerBlock("gulltown_green_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block GULLTOWN_GREEN_PLASTER_ROUGH_WALL = registerBlock("gulltown_green_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block GULLTOWN_GREEN_PLASTER_ROUGH_FENCE = registerBlock("gulltown_green_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block GREEN_PLASTER_WALL = registerBlock("green_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block GREEN_PLASTER_FENCE = registerBlock("green_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block GREEN_PLASTER_ROUGH_WALL = registerBlock("green_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block GREEN_PLASTER_ROUGH_FENCE = registerBlock("green_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block HIGHGARDEN_GREEN_PLASTER_WALL = registerBlock("highgarden_green_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block HIGHGARDEN_GREEN_PLASTER_FENCE = registerBlock("highgarden_green_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block HIGHGARDEN_GREEN_PLASTER_ROUGH_WALL = registerBlock("highgarden_green_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block HIGHGARDEN_GREEN_PLASTER_ROUGH_FENCE = registerBlock("highgarden_green_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block GULLTOWN_BLUE_PLASTER_WALL = registerBlock("gulltown_blue_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block GULLTOWN_BLUE_PLASTER_FENCE = registerBlock("gulltown_blue_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block GULLTOWN_BLUE_PLASTER_ROUGH_WALL = registerBlock("gulltown_blue_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block GULLTOWN_BLUE_PLASTER_ROUGH_FENCE = registerBlock("gulltown_blue_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block LIGHT_BLUE_PLASTER_WALL = registerBlock("light_blue_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block LIGHT_BLUE_PLASTER_FENCE = registerBlock("light_blue_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block LIGHT_BLUE_PLASTER_ROUGH_WALL = registerBlock("light_blue_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block LIGHT_BLUE_PLASTER_ROUGH_FENCE = registerBlock("light_blue_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block BLUE_PLASTER_WALL = registerBlock("blue_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block BLUE_PLASTER_FENCE = registerBlock("blue_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block BLUE_PLASTER_ROUGH_WALL = registerBlock("blue_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block BLUE_PLASTER_ROUGH_FENCE = registerBlock("blue_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block LIGHT_PURPLE_PLASTER_WALL = registerBlock("light_purple_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block LIGHT_PURPLE_PLASTER_FENCE = registerBlock("light_purple_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block LIGHT_PURPLE_PLASTER_ROUGH_WALL = registerBlock("light_purple_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block LIGHT_PURPLE_PLASTER_ROUGH_FENCE = registerBlock("light_purple_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PURPLE_PLASTER_WALL = registerBlock("purple_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PURPLE_PLASTER_FENCE = registerBlock("purple_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PURPLE_PLASTER_ROUGH_WALL = registerBlock("purple_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PURPLE_PLASTER_ROUGH_FENCE = registerBlock("purple_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PALE_PURPLE_PLASTER_WALL = registerBlock("pale_purple_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PALE_PURPLE_PLASTER_FENCE = registerBlock("pale_purple_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PALE_PURPLE_PLASTER_ROUGH_WALL = registerBlock("pale_purple_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PALE_PURPLE_PLASTER_ROUGH_FENCE = registerBlock("pale_purple_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block HIGHGARDEN_PINK_PLASTER_WALL = registerBlock("highgarden_pink_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block HIGHGARDEN_PINK_PLASTER_FENCE = registerBlock("highgarden_pink_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block HIGHGARDEN_PINK_PLASTER_ROUGH_WALL = registerBlock("highgarden_pink_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block HIGHGARDEN_PINK_PLASTER_ROUGH_FENCE = registerBlock("highgarden_pink_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PINK_PLASTER_WALL = registerBlock("pink_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PINK_PLASTER_FENCE = registerBlock("pink_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PINK_PLASTER_ROUGH_WALL = registerBlock("pink_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PINK_PLASTER_ROUGH_FENCE = registerBlock("pink_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PALE_PINK_PLASTER_WALL = registerBlock("pale_pink_plaster_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PALE_PINK_PLASTER_FENCE = registerBlock("pale_pink_plaster_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    ...
    public static final Block PALE_PINK_PLASTER_ROUGH_WALL = registerBlock("pale_pink_plaster_rough_wall", new WcWall(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
    public static final Block PALE_PINK_PLASTER_ROUGH_FENCE = registerBlock("pale_pink_plaster_rough_fence", new WcFence(FabricBlockSettings.copyOf(Blocks.QUARTZ_BLOCK).requiresTool()));
