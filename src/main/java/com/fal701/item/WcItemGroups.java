...
public class WcItemGroups {
    public static final ItemGroup COBBLESTONE = FabricItemGroup.builder()
            ...
            .entries((context, entries) -> {
                ...
                entries.add(Cobblestone.BROWN_GREY_COBBLESTONE_TIP); //7
                ...
                entries.add(Cobblestone.BROWN_GREY_DARK_COBBLESTONE_TIP); //8
                ...
                entries.add(Cobblestone.BROWN_GREY_COBBLE_TIP); //9
                ...
                entries.add(Cobblestone.BROWN_GREY_RIVER_COBBLE_TIP); //10
                ...
                entries.add(Cobblestone.DARK_COBBLESTONE_TIP); //11
                ...
                entries.add(Cobblestone.GREEN_GREY_COBBLESTONE_TIP); //12
                ...
                entries.add(Cobblestone.GREY_DARK_COBBLESTONE_TIP); //13
                ...
                entries.add(Cobblestone.RIVER_COBBLE_TIP); //14
                ...
                entries.add(Cobblestone.FAINT_LIGHT_GREY_COBBLESTONE_TIP); //15
                ...
                entries.add(Cobblestone.FAINT_LIGHT_GREY_DARK_COBBLESTONE_TIP); //16
                ...
                entries.add(Cobblestone.WHITE_COBBLESTONE_TIP); //17
                ...
                entries.add(Cobblestone.WHITE_DARK_COBBLESTONE_TIP); //18
                ...
                entries.add(Cobblestone.REACH_COBBLESTONE_TIP); //19
                ...
                entries.add(Cobblestone.REACH_DARK_COBBLESTONE_TIP); //20
                ...
                entries.add(Cobblestone.SANDY_PINK_COBBLESTONE_TIP); //21
                ...
                entries.add(Cobblestone.SANDY_PINK_DARK_COBBLESTONE_TIP); //22
                ...
                entries.add(Cobblestone.KL_DUN_COBBLE_TIP); //23
                ...
                entries.add(Cobblestone.RED_COBBLESTONE_TIP); //24
                ...
                entries.add(Cobblestone.COARSE_RED_DARK_COBBLESTONE_TIP); //25
                ...
                entries.add(Cobblestone.OLDTOWN_COBBLESTONE_TIP); //26
                ...
                entries.add(Cobblestone.OLDTOWN_DARK_COBBLESTONE_TIP); //27
                ...
                entries.add(Cobblestone.ARBOR_COBBLESTONE_TIP); //28
                ...
                entries.add(Cobblestone.ARBOR_DARK_COBBLESTONE_TIP); //29
                ...
                entries.add(Cobblestone.LANNISPORT_COBBLESTONE_TIP); //30
                ...
                entries.add(Cobblestone.LANNISPORT_DARK_COBBLESTONE_TIP); //31
                ...
                entries.add(Cobblestone.STORMLAND_COBBLESTONE_TIP); //32
                ...
                entries.add(Cobblestone.STORMLAND_DARK_COBBLESTONE_TIP); //33
                ...
                entries.add(Cobblestone.STORMLAND_MOSSY_COBBLESTONE_TIP); //34
                ...
                entries.add(Cobblestone.TERRACOTTA_COBBLESTONE_TIP); //35
            }).build();
